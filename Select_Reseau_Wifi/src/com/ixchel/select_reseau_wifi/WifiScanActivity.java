...
public class WifiScanActivity extends Activity implements OnClickListener {
	...
	// L'identifiant de la chaîne de caractères qui contient le	résultat de l'intent
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		// On vérifie tout d'abord à quel intent on fait référence ici à l'aide de notre identifiant
		if (requestCode == CHOOSE_BUTTON_REQUEST) {
			// On vérifie aussi que l'opération s'est bien déroulée 
			if (resultCode == RESULT_OK) {
				// On affiche le bouton qui a été choisi
